...
xdescribe('[index.flagAlertsHandler]', () => {
    ...
    beforeEach(() => {
        _handler = _rewire('../../../src/handlers/flag-alerts-handler');
    });

    describe('[execution]', () => {
        it('should invoke the callback with a success message', () => {
            const wrapper = _createWrapper(undefined, 'dev');
            const expectedMessage = 'Lambda function [flag_alerts] executed successfully';
