...
module.exports = function(grunt) {
    ...
    const AWS_S3_BUCKET = 'missile-defense-rjdsegzfe';
    ...
    grunt.initConfig({
        ...
        generate_cf_template: {
            ...
            core: {
                description: 'missile-defense (CORE)',
                output: {
            ...
            api: {
                description: 'missile-defense (API)',
                output: {
            ...
            dev: {
                description: 'missile-defense (DEV)',
                output: {
            ...
            qa: {
                description: 'missile-defense (QA)',
                output: {
            ...
            prod: {
                description: 'missile-defense (PROD)',
                output: {
